...
CUDA_VISIBLE_DEVICES=${GPU}   python   main.py \
                                    ...
                                    --ST_model_path "${model_dir}/Single_Hu_Rs_Cat_SABERT_Cls_And_SSA_StructurePath" \
                                    --TST_model_path "${model_dir}/Single_Hu_Rs_Cat_SABERT_Cls_And_SSA_StructurePath" \
                                    --with_spk_embedding \
                                    -cat_cls_structurePath \
                                    --num_layers 1 \
                                    --max_edu_dist 16 