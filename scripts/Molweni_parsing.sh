...
CUDA_VISIBLE_DEVICES=${GPU}  nohup python -u ../main.py \
                                    ...
                                    --do_train \
                                    --ST_model_path "${model_dir}/mol_parsing_bertWithSpeakerIds" \
                                    --TST_model_path "${model_dir}/mol_parsing_bertWithSpeakerIds" \
                                    --seed 65534 >../logs/mol_parsing_bertWithSpeakerIds.log 2>&1 &