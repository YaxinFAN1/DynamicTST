...
CUDA_VISIBLE_DEVICES=${GPU}  nohup python -u main.py \
                                    ...
                                    --do_train \
                                    --TST_epoches 10 \
                                    --ST_model_path "${model_dir}/mol_parsing_bert_ssa_withoutGRU" \
                                    --TST_model_path "${model_dir}/mol_parsing_bert_ssa_withoutGRU" \
                                    --seed 65534 > ./logs/mol_parsing_bert_ssa_withoutGRU.log 2>&1 &