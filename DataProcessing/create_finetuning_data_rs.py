# -*- encoding: utf-8 -*-
'''
file       :create_finetuning_data_rs.py
Description:
Date       :2024/03/12 11:42:10
Author     :Yaxin Fan
...
# tf.flags.DEFINE_string("train_file", "../TSTRL/Data/Hu_Dataset/train.json", 
#                        "path to train file")
# tf.flags.DEFINE_string("valid_file", "../TSTRL/Data/Hu_Dataset/dev.json", 
#                        "path to valid file")
# tf.flags.DEFINE_string("test_file", "../TSTRL/Data/Hu_Dataset/test.json", 
#                        "path to test file")
...
if __name__ == "__main__":
    ...
    for (filename, filetype, n_negative) in zip(filenames, filetypes, file_n_negative):
        ...
        features = convert_examples_to_features(examples, label_list, hu_config.max_seq_length, hu_config.tokenizer)
