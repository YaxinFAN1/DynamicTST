...
class Mol_Configs:
    def __init__(self) -> None:
        ...
        self.output_ar_dir = '../../TSTRL/Data/Molweni/Mol_AR_Dir'
        self.output_link_dir = '../../TSTRL/Data/Molweni/Mol_Link_Dir'
...
if __name__ == '__main__':
    ...
    for dataset_file in [mol]:
        ...
        for (filename, filetype) in zip(filenames, filetypes):
            ...
            new_filename = dataset_file.output_ar_dir + "/{}_ar.json".format(filetype)
            write_des(examples, des_file=new_filename)
            conaddParsingType  = Convert_ARlabel2_Link()
            conaddParsingType.write_des(dataset_file.output_ar_dir + '/{}_ar.json'.format(filetype),
                                    dataset_file.output_link_dir + '/{}_link.json'.format(filetype))
